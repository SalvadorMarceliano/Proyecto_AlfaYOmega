    <div class="wrapper">
        ...
        <nav style="background-color: #000942;" id="sidebar">
            ...
            <ul class="list-unstyled components">
                <!--<li class="<?php echo e('home'==request()->path()?'active':''); ?>">
                    <a href="<?php echo e(url('/home')); ?>">
                        <i class="fas fa-user"></i>
                        <b>Usuarios</b>
                    </a>                    
                </li>-->
                <li class="<?php echo e('productos'==Request::is('productos*')?'active': ''); ?>">
                    <a href="<?php echo e(route('productos.index')); ?>">
                        <i class="fas fa-box-open"></i>
                        <b>Productos</b>
                    </a>
                </li>
                <li class="<?php echo e('clientes'==Request::is('clientes*')?'active': ''); ?>">
    ...
    </script><?php /**PATH C:\xampp\htdocs\proyecto-disi\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>